...
type HecklerdConf struct {
	...
	CMAdapterConfig            cm_models.ChangeManagementAdapterConfig `yaml:"change_management_adapter_config"`
}
...
func parseTemplates(defaultTemplatesPath string) *template.Template {
